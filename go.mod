module github.com/thalassa-cloud/cloud-provider-thalassa
...
require (
	...
	github.com/thalassa-cloud/client-go v0.14.5
...
replace k8s.io/legacy-cloud-providers => k8s.io/legacy-cloud-providers v0.31.3
...
replace k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20250304201544-e5f78fe3ede9
...
replace github.com/openshift/api => github.com/openshift/api v0.0.0-20250305225826-b8da3bfeaf77
